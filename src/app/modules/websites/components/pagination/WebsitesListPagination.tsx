...
} from "../../../apps/user-management/users-list/core/QueryResponseProvider.tsx";
  ...
  return (
      <div className='row'>
          ...
          <div className='col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end'>
              <div id='kt_table_websites_paginate'>
