...
import { DealStatus } from '../../../app/modules/deals/deals-list/core/_models'
...
// Helper function to get the readable name of the status
const getStatusName = (status: DealStatus): string => {
  switch (status) {
